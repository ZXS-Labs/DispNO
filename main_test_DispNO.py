...
args.loadckpt = './checkpoints/sceneflow/DispNO/truetrue8/checkpoint_000015.ckpt'
...
def test():
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        # test
        os.makedirs('./predictions_sceneflow_DispNO_scale5', exist_ok=True)
        ...
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            if batch_idx % 10 == 0:
                for disp_est, top_pad, right_pad, fn in zip(disp_est_np, top_pad_np, right_pad_np, left_filenames):
                    ...
                    fn_arr = fn.split('/')
                    fn = os.path.join("predictions_sceneflow_DispNO_scale5", fn_arr[2] + '-' + fn_arr[3] + '-' + fn_arr[5])
