...
python main_kitti12_DispNO.py --dataset kittiDispNO \
    ...
    --model gwcnet-gc-dispNO --logdir ./checkpoints/kitti12/DispNO/piancha_Horizon_def3_best_s1/ \
...
python main_kitti12_DispNO.py --dataset kittiDispNO \
    --datapath $DATAPATH --trainlist ./filenames/kitti12_train.txt --testlist ./filenames/kitti12_val.txt \
    --epochs 300 --lrepochs "200, 600:10" \
    --model gwcnet-gc-dispNO --logdir ./checkpoints/kitti12/DispNO/piancha_Horizon_def3_best_s2/ \
    --loadckpt ./checkpoints/sceneflow/DispNO/truetrue8/checkpoint_000015.ckpt \
    --test_batch_size 1 \
    --out_add 'true' --key_query_same 'true' --deformable_groups 8 \
    --output_representation 'bimodal' --sampling 'dda' \
...
python main_kitti12_DispNO.py --dataset kittiDispNO \
    --datapath $DATAPATH --trainlist ./filenames/kitti12_train.txt --testlist ./filenames/kitti12_val.txt \
    --epochs 300 --lrepochs "200, 600:10" \
    --model gwcnet-gc-dispNO --logdir ./checkpoints/kitti12/DispNO/piancha_Horizon_def3_best_s3/ \
    --loadckpt ./checkpoints/sceneflow/DispNO/truetrue8/checkpoint_000015.ckpt \
    --test_batch_size 1 \
    --out_add 'true' --key_query_same 'true' --deformable_groups 8 \
    --output_representation 'bimodal' --sampling 'dda' \
