...
args.loadckpt = "./checkpoints/UnrealStereo/HDA/piancha_Horizon_def3_best_s1/truetrue8/checkpoint_000277_best.ckpt"
...
def test():
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        # test
        os.makedirs('./predictions_Unreal_HDA', exist_ok=True)
        ...
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            for disp_est, top_pad, right_pad, fn in zip(disp_est_np, top_pad_np, right_pad_np, left_filenames):
                ...
                fn = os.path.join("predictions_Unreal_HDA", fn.split('/')[-1])
